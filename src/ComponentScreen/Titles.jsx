...
import { HookToTitles } from "../Hooks/HookToTitles";

export const Titles = () => {
    const { dataForm, resultado, changeHandler, submitHandler } = HookToTitles();
    ...
    const url = `https://127.0.0.1/titles`;
      ...
      <div className="mt-2 ml-4">
        <nav className="nav nav-pills nav-fill">
          <ul className="nav nav-pills">
              ...
              <li className="nav-item">
                <a className="nav-link active" aria-current="page" href="/titles"><i className='fa fa-graduation-cap' style={{ fontSize: "19px" }}></i>&nbsp;Titles</a>
              </li>
              <li className="nav-item">
      ...
      <div>
        <section className="container mt-4 mb-1 show" id="crud1">
          <div className="text-start" id="employees">
            <h5><i className='fa fa-plus-circle' style={{ fontSize: "19px", color: "green" }}></i>&nbsp;Create Titles</h5>
          </div>
          <div
          ...
          >
            <form onSubmit={submitHandler}>
              <div className="row col-sm-12 col-md-12 col-lg-12">
                ...
                <div className="mb-3 col-sm-3 col-md-3 col-lg-3">
                  <input type="text" className="form-control" name="nombre" id="nombre" aria-labelledby="emailHelp" placeholder="Title" onChange={changeHandler} />
                </div>
                <div className="mb-3 col-sm-3 col-md-3 col-lg-3">
