...
import { HookToSalaries } from "../Hooks/HookToSalaries";
            ...
            <form onSubmit={submitHandler}>
              <div className="row col-sm-12 col-md-12 col-lg-12">
                ...
                <div className="mb-3 col-sm-3 col-md-3 col-lg-3">
                  <input type="date" className="form-control" name="desde" id="desde" aria-labelledby="emailHelp" placeholder="Desde" onChange={changeHandler}/>
                </div>
                <div className="mb-3 col-sm-3 col-md-3 col-lg-3">
                  <input type="date" className="form-control" name="hasta" id="hasta" aria-labelledby="emailHelp" placeholder="Hasta" onChange={changeHandler}/>
                </div>
                <div className="mb-3 col-sm-3 col-md-3 col-lg-3">
                  <input type="number" className="form-control" name="salario" id="salario" aria-labelledby="emailHelp" placeholder="Salario" onChange={changeHandler}/>
                </div>
              </div>
